Feature: Vacation generator functionality
  ...
  @vacation
  Scenario: [TC0010] User provides all mandatory vacation parameters
  ...
  Scenario: [TC0011] User views previous vacation plans
    Given I got navigated to Login page
  ...
  Scenario: [TC0012] User selects suggestion options
    Given I got navigated to Login page
    When I enter login username as "abc"
    And I enter login password as "123"
    And I click Login button
  ...
  Scenario: [TC0013] User enters negative value of budget
  Given I got navigated to Login page
    When I enter login username as "abc"
    And I enter login password as "123"
    And I click Login button
  ...
  Scenario: [TC0014] User enters return date earlier than departure date
    Given I got navigated to Login page
    When I enter login username as "abc"
    And I enter login password as "123"
    And I click Login button
  ...
  @vacation @pdf_export
  Scenario: [TC0015] User sees presence of PDF download link
    Given I got navigated to Login page
    When I enter login username as "abc"
    And I enter login password as "123"
    And I click Login button
  ...
  @vacation @error_message
  Scenario: [TC0016] User skips required fields for trip planning
    Given I got navigated to Login page
    When I enter login username as "abc"
    And I enter login password as "123"
    And I click Login button
  ...
  Scenario: [TC0017] User views previous trip settings
    Given I got navigated to Login page
